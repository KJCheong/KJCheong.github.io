...
function Engineshow() {
  ...
  if (x.innerHTML === " ") {
    x.innerHTML = "<h3>Engine go crazy</h3><p>The Engine powering the R32 is a RB26DETT (6-cyl. In line, 4-valve DOHC + turbo) making about 2,568cc it can rev up to 6,800rpm making about 276 horse power and a 0-60 in about 5 seconds. However in the current day and age where aftermarket parts and other accesories become more widely available the power of this engine can be pushed to the higher ends of about 1000 horse power.</p>";
  }
}
...
function Dimeshow() {
  ...
  if (x.innerHTML === " ") {
    x.innerHTML = "<h3>Dimensions go crazy</h3><p>The overall length,width and height is 4.6m,1,78m and 1.36m respetively and weighs 1560kgs which allows it to average 11.8 liters per kilometer which by todays standards is quite high but for a sports car of this calibre the kmpl is already conidered quite normal.</p>";
  }
}
